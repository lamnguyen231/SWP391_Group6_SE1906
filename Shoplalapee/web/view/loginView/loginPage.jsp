    ...
    <div class="row justify-content-center">
        <div class="col-sm-6">
            <div class="login-form">
                ...
                <!-- Login with Facebook -->
                <a data-mdb-ripple-init class="btn btn-primary btn-lg btn-block mb-2" style="background-color: #3b5998"
                   href="${Oauth_Config.FACEBOOK_LINK_GET_CODE}" role="button">
                    <i class="fab fa-facebook-f me-2"></i>Continue with Facebook
                </a>
                <!-- Login with Google -->
                <a data-mdb-ripple-init class="btn btn-danger btn-lg btn-block btnGoogle"
                   href="${Oauth_Config.GOOGLE_LINK_GET_CODE}" role="button">
                    <i class="fa-brands fa-google-plus-g me-2"></i>Continue with Google
                </a>
            </div>
        </div>
    </div>
