    ...
    <body>
        ...
        <div class="taskbar">
            <div>
                <button onclick="goHome()">
                    <a href="managecategory" class="add-user-button">Category</a>
                </button>
            </div>
           
             <div>  <button onclick="">
                    <a href="addfilter?category_id=${category_id}" class="add-user-button">Add Filter</a>
                </button></div>
        ...
        <table>
            ...
            <tbody>
                ...
                <c:forEach items="${listFilter}" var="i">
                    <tr>
                        <td>${i.filter_id}</td>
                        <td>${i.nameFilter}</td>
                        <td>${category.getCategoryById(i.category_id).getCategory_name()    }</td>
